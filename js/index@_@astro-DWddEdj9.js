import { A as AstroError, E as ExpectedImage, L as LocalImageUsedWrongly, M as MissingImageDimension, U as UnsupportedImageFormat, I as IncompatibleDescriptorOptions, g as UnsupportedImageConversion, t as toStyleString, N as NoImageMetadata, F as FailedToFetchRemoteImageDimensions, h as ExpectedImageOptions, i as ExpectedNotESMImage, j as InvalidImageService, d as createAstro, c as createComponent, k as ImageMissingAlt, m as maybeRenderHead, b as addAttribute, s as spreadAttributes, a as renderTemplate, l as ExperimentalFontsNotEnabled, n as FontFamilyNotFound, u as unescapeHTML, r as renderComponent } from './astro/server-M9bQ9WI3.js';
import 'kleur/colors';
import { $ as $$PageLayout } from './PageLayout-CN4Pn1T-.js';
...
const baseService = {
  ...
  getURL(options, imageConfig) {
    ...
    const imageEndpoint = joinPaths("/astro-template_v-01/", imageConfig.endpoint.route);
...
}, "/home/runner/work/astro-template_v-01/astro-template_v-01/node_modules/astro/components/Image.astro", void 0);
...
const aboutImg = new Proxy({"src":"/astro-template_v-01/assets/bg-03-UOU7RUNW.jpg","width":2560,"height":1024,"format":"jpg"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/home/runner/work/astro-template_v-01/astro-template_v-01/src/assets/images/content/bg-03.jpg";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("/home/runner/work/astro-template_v-01/astro-template_v-01/src/assets/images/content/bg-03.jpg");
							return target[name];
						}
					});

const $$About = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<div class="about" data-astro-cid-zsov6f23> <div class="about__container" data-astro-cid-zsov6f23> <div class="about__col" data-astro-cid-zsov6f23> <h3 class="about__title" data-astro-cid-zsov6f23>About title</h3> <h3 class="about__subtitle" data-astro-cid-zsov6f23>About subtitle</h3> </div> <div class="about__col" data-astro-cid-zsov6f23></div> <div class="about__wrap-img" data-astro-cid-zsov6f23> ${renderComponent($$result, "Image", $$Image, { "class": "about__img", "src": aboutImg, "alt": "foto about", "data-astro-cid-zsov6f23": true })} </div> </div> </div> `;
}, "/home/runner/work/astro-template_v-01/astro-template_v-01/src/components/sections/About.astro", void 0);

const $$Index = createComponent(($$result, $$props, $$slots) => {
  const title = "\u0413\u043B\u0430\u0432\u043D\u0430\u044F";
  return renderTemplate`${renderComponent($$result, "PageLayout", $$PageLayout, { "title": title }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="hero"> <div class="hero__container"> <h1>${title}</h1> <p>Сейчас должен сгенерировать файл стилей</p> </div> ${renderComponent($$result2, "About", $$About, {})} </div> ` })}`;

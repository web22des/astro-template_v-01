...
const $$Header = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<div class="header" data-astro-cid-x3onawaz> <div class="header__container" data-astro-cid-x3onawaz> <div class="header__body" data-astro-cid-x3onawaz> <div class="header__logo" data-astro-cid-x3onawaz> ${renderComponent($$result, "Logo", $$Logo, { "data-astro-cid-x3onawaz": true })} </div> <div class="header__nav" data-astro-cid-x3onawaz> ${renderComponent($$result, "NavMenu", $$NavMenu, { "items": menuItems, "data-astro-cid-x3onawaz": true })} </div> <div class="header__contacts" data-astro-cid-x3onawaz> ${renderComponent($$result, "ContactsIcons", $$ContactsIcons, { "data-astro-cid-x3onawaz": true })} </div> <div class="header__burger" data-astro-cid-x3onawaz></div> </div> <div class="header__footer" data-astro-cid-x3onawaz> ${renderComponent($$result, "ThemeToggle", $$ThemeToggle, { "initialTheme": "light", "data-astro-cid-x3onawaz": true })} </div> </div> </div> <!--  --> `;

...
import 'kleur/colors';
import { $ as $$PageLayout } from './PageLayout-BoDoVNLm.js';
...
const bg01 = new Proxy({"src":"/astro-template_v-01/assets/bg-01-C9E5LUaV.jpg","width":2560,"height":1080,"format":"jpg"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "/home/runner/work/astro-template_v-01/astro-template_v-01/src/assets/images/content/bg-01.jpg";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("/home/runner/work/astro-template_v-01/astro-template_v-01/src/assets/images/content/bg-01.jpg");
							return target[name];
						}
					});

const bg02 = new Proxy({"src":"/astro-template_v-01/assets/bg-02-UY4Lb4C-.jpg","width":2560,"height":1080,"format":"jpg"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/home/runner/work/astro-template_v-01/astro-template_v-01/src/assets/images/content/bg-02.jpg";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("/home/runner/work/astro-template_v-01/astro-template_v-01/src/assets/images/content/bg-02.jpg");
							return target[name];
						}
					});

const bg03 = new Proxy({"src":"/astro-template_v-01/assets/bg-03-UOU7RUNW.jpg","width":2560,"height":1024,"format":"jpg"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
...
const $$Index = createComponent(($$result, $$props, $$slots) => {
  const title = "\u0413\u043B\u0430\u0432\u043D\u0430\u044F";
  return renderTemplate`${renderComponent($$result, "PageLayout", $$PageLayout, { "title": title }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="hero"> <div class="hero__container"> <h1>${title}</h1> <p>Сейчас должен сгенерировать файл стилей</p> ${renderComponent($$result2, "TestComponent", $$TestComponent, {})} </div> </div> ` })}`;
